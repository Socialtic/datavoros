...
- Una vez registrado, la persona usuaria puede cambiar el número con el que se registró. La propia aplicación otorga, como se ve en [esta](./captura_pantalla/mujer_alerta_veracruz%20(29).png) captura de pantalla, el código de verificación. Esto permite registrar cualquier número de celular. 
